    ...
    <form action="#" @submit.prevent="submitForm">
      <div class="p-3">
        <div class="mb-4 text-center">
          <h3 class="font-weight-bold">Contact Promoter</h3>
        </div>

        <div class="mb-3">
          <label-component for="event-help-email-address" text="Email address"></label-component>

          <input-component
            id="event-help-email-address"
            name="event-help-email-address"
            placeholder="Enter your email address"
            :class="(errors.has('event-help-email-address')) ? 'input-error' : ''"
        ...
        <div class="mb-4">
          <label-component for="event-help-message" text="Message"></label-component>

          <textarea
            id="event-help-message"
            name="event-help-message"
            class="form-control"
            cols="30"
            rows="5"
            :class="(errors.has('event-help-message')) ? 'border-danger text-danger' : ''"
            v-validate="'required'"
            v-model="message"
          ></textarea>
        </div>
...
export default class EventContactPromotorModalComponent extends Vue {
  public $refs!: {
    modal: any;
  };
